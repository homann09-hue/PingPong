...
const games = [
  GameDefinition(
    ...
    jackpot: '72.450.000',
    unlockLevel: 1,
    features: 'MYSTERY REVEALS • EXPANDING WILDS • 2× FREE SPINS',
  ...
  GameDefinition(
    ...
    jackpot: '96.750.000',
    unlockLevel: 12,
    features: '9-CHEST TREASURE BOARD • 3 PICKS • COIN COLLECT',
  ...
  GameDefinition(
    ...
    jackpot: '64.750.000',
    unlockLevel: 7,
    features: 'SPECIAL FREE-SPIN REELS • +1 ICE WILD • RETRIGGERS',
